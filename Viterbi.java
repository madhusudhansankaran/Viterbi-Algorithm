...
{
	//The main method to call all other functions and calculate the most likely sequence.
	public static void main(String args[]) throws NumberFormatException, IOException
	{
		...
		for(int i=0;i<obs;i++)
		{				
			System.out.println("The most probable sequence for observation " +(i+1) +":");
			c.initialize(number_sequence[i], number_states,output_dist,a,initprob,output_alpha,s1[i]);
			c.calculateRest(number_sequence[i], number_states,output_dist,a,initprob,output_alpha,s1[i]);
			System.out.println("\n");
		}
	}
}